app.controller('myCtrl',['$scope','$http', function ($scope, $http) {
    $http.get('http://localhost/didisvr/public/index.php/selectInfo').then(function (res) {
...
//下一页
    ...
    $scope.del = function ($index) {
        if ($index >= 0) {
            ...
            var url = 'http://localhost/didisvr/public/index.php/del/' + id;
    ...
    $scope.save = function () {
        ...
        var url = 'http://localhost/didisvr/public/index.php/addCraft/' + info;
    ...
    $scope.ensure = function () {
        ...
        var url = 'http://localhost/didisvr/public/index.php/updata/' + updata1;
        $http.get(url).then(function (res) {
